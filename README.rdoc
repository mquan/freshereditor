...
- minor rewrite to make code less redundant since lots of command have the form: 
...
<head>
	...
	$(document).ready(function() {
		$('#content-editor').freshereditor({toolbar_selector: "#toolbar", excludes: ['strikethrough', 'removeFormat', 'insertheading4']});
